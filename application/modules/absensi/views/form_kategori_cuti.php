	...
	<body>
						...
						<div class="col-sm-12 col-lg-12">
							<div class="panel">
								<div class="panel-header"> 
									...
									<div class="text-left">
										<h3><b>Form Kategori Cuti</b></h3>
									</div>
								</div>
								<div class="panel-content">
									<form method="POST" action="<?php echo site_url('absensi/submit_kategori_cuti');?>" id="form-po" enctype="multipart/form-data" autocomplete="off">
										<div class="row">
											<div class="col-sm-2">
		...
		<script type="text/javascript">
			...
			$('#form-po').submit(function(e){
				...
				bootbox.confirm({
					message: "Apakah anda yakin menambahkan kategori cuti baru sekarang ?",
					buttons: {
						confirm: {
							label: 'Yes',
