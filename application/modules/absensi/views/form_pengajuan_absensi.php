	...
	<body>
							...
							<div class="panel">
								<div class="panel-header"> 
									...
									<div class="text-center">
										<h3><b>Form Pengajuan Absensi</b></h3>
									</div>
								</div>
								<div class="panel-content">
									<form method="POST" action="<?php echo site_url('absensi/submit_pengajuan_absensi');?>" id="form-po" enctype="multipart/form-data" autocomplete="off">
										<div class="row">
											<div class="col-sm-2">
		...
		<script type="text/javascript">
			$('#form-po').submit(function(e){
				...
				bootbox.confirm({
					message: "Apakah anda yakin mengirim pengajuan absensi sekarang ?",
					buttons: {
						confirm: {
							label: 'Yes',
