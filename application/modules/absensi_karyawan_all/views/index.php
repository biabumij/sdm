                            ...
                            <div class="panel">
                                <div class="panel-header">
                                    <h3 class="section-subtitle">
                                        <b style="text-transform:uppercase;">REKAP ABSENSI ALL</b>
                                    </h3>
                                    <div class="text-left">
                                ...
                                <div class="panel-content">
                                    ...
                                    <br />
                                        <div role="tabpanel" class="tab-pane active" id="absensi">
                                            <form action="<?php echo site_url('absensi_karyawan_all/cetak_absensi');?>" target="_blank">
                                                <div class="col-sm-3">
        ...
        <script type="text/javascript">
            ...
            var table_absensi = $('#table_absensi').DataTable( {"bAutoWidth": false,
                ajax: {
                    processing: true,
                    serverSide: true,
                    url: '<?php echo site_url('absensi_karyawan_all/table_absensi'); ?>',
                    type: 'POST',
                    data: function(d) {
            ...
            var table_cuti = $('#table_cuti').DataTable( {"bAutoWidth": false,
                ajax: {
                    processing: true,
                    serverSide: true,
                    url: '<?php echo site_url('absensi_karyawan/table_cuti'); ?>',
                    type: 'POST',
                    data: function(d) {
