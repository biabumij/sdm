	...
	<body>
						...
						<div class="col-sm-12 col-lg-12">
							<div class="panel">
								...
								<div class="panel-content">
									<form method="POST" action="<?php echo site_url('absensi/submit_cuti');?>" id="form-po" enctype="multipart/form-data" autocomplete="off">
										<div class="row">
											<div class="col-sm-2">
												<label>Tipe Cuti</label>
											</div>
											<div class="col-sm-2">
												<select class="form-control form-select2" name="type" required="" >
													<option value="">Pilih</option>
													<?php
													if(!empty($tipe_cuti)){
														foreach ($tipe_cuti as $x) {
															?>
											...
											<div class="col-sm-6">
												<input type="text" class="form-control" name="reason" value="" required="" placeholder="Mohon isi alasan cuti">
											</div>
											<br />
											<br />
											<div class="col-sm-2">
												<label>Pengganti (Opsional)</label>
											</div>
											<div class="col-sm-2">
												<select class="form-control form-select2" name="tipe">
													<option value="">Pilih</option>
													<?php
													if(!empty($admin)){
														foreach ($admin as $x) {
															?>
															<option value="<?php echo $x['id'];?>"><?php echo $x['admin_name'];?></option>
															<?php
														}
													}
													?>
		...
		<script type="text/javascript">
			...
			$('#form-po').submit(function(e){
				...
				bootbox.confirm({
					message: "Apakah anda yakin mengajukan cuti sekarang ?",
					buttons: {
						confirm: {
							label: 'Yes',
